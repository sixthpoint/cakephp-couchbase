...
/* Logging custom exceptions throw from LogExceptionHandler.php */
//Configure::write('Exception.handler', 'LogExceptionHandler::handle');
 ...
 *
 */
// Allow sessions to be passed from SLL to non-SSL
...
// On page reload reset the counter for session timeout
 ...
 */
Configure::write('Security.salt', '23lkjldn2kl3nlkl');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
Configure::write('Security.cipherSeed', '84615794597815647849126894156');
